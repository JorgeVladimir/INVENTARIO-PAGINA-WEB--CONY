    ...
    <footer className="bg-slate-900 text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
        ...
        <div className="space-y-8">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-12 h-12 bg-china-red rounded-2xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform">
              <Store className="text-white" size={28} />
            </div>
            <div>
              <h1 className="font-black text-2xl tracking-tighter text-white">SINOSTOCK</h1>
              <p className="text-[10px] text-china-gold font-black uppercase tracking-widest">Grupo Lina</p>
            </div>
          </Link>
        ...
        <div className="space-y-8">
          ...
          <ul className="space-y-6">
            <li className="flex items-start gap-4">
              ...
              <span className="text-slate-400 text-sm font-medium">Av. Amazonas y Naciones Unidas, Quito, Ecuador</span>
            </li>
            <li className="flex items-center gap-4">
              <Phone className="text-china-red shrink-0" size={20} />
              <span className="text-slate-400 text-sm font-medium">+593 99 123 4567</span>
            </li>
            <li className="flex items-center gap-4">
              <Mail className="text-china-red shrink-0" size={20} />
              <span className="text-slate-400 text-sm font-medium">ventas@sinostock.com</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 pt-10 border-t border-white/5 flex flex-col md:row justify-between items-center gap-6">
        <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em]">
          © 2024 SINOSTOCK ECUADOR. TODOS LOS DERECHOS RESERVADOS.
        </p>
